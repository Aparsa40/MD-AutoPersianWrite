...
export const TableOfContents: React.FC = () => {
  ...
  const jumpToHeading = (heading: Heading, index: number) => {
    ...
    const previewHeadings = document.querySelectorAll<HTMLElement>('[data-preview-heading="true"]');
    previewHeadings[index]?.scrollIntoView({ behavior: 'smooth', block: 'start' });
  };

  return (
    <aside className="h-full w-64 shrink-0 overflow-y-auto border-l border-border bg-surface p-4 custom-scrollbar">
